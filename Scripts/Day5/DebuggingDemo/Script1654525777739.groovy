...
WebUI.click(findTestObject('Object Repository/input_Apply for hospital readmission_hospit_63901f'))

WebUI.click(findTestObject('Object Repository/input_None_programs'))

WebUI.click(findTestObject('Object Repository/span_Visit Date (Required)_glyphicon glyphi_cada34'))

WebUI.click(findTestObject('Object Repository/td_10'))

WebUI.click(findTestObject('Object Repository/button_Book Appointment'))

WebUI.click(findTestObject('Object Repository/h2_Appointment Confirmation'))

WebUI.verifyElementText(findTestObject('Object Repository/h2_Appointment Confirmation'), 'Appointment Confirmation')
